...
public class Withdraw {
    ...
    public void withdraw(User requester, String accountNumber, double amount) throws BusinessException {
        if (requester.getRole() != UserRole.TELLER_EMPLOYEE)
            throw new BusinessException("Acceso denegado: solo el cajero puede realizar retiros");

        if (amount <= 0)
            throw new BusinessException("El monto del retiro debe ser mayor a cero");
